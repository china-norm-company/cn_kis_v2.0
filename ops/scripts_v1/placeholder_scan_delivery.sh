#!/bin/bash
# 防走样：交付路径占位符与禁用词扫描
# 扫描 apps/wechat-mini 与受试者相关后端，禁止 TODO/待实现/mock-only/占位 作为交付态
...
DELIVERY_DIRS="apps/wechat-mini/src backend/apps/subject backend/apps/identity backend/apps/visit backend/apps/notification backend/apps/edc backend/apps/qrcode"
