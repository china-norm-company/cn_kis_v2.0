...
FEISHU_APP_ID_IAM = os.getenv('FEISHU_APP_ID_IAM', '')
FEISHU_APP_SECRET_IAM = os.getenv('FEISHU_APP_SECRET_IAM', '')
FEISHU_APP_ID_DATA_PLATFORM = os.getenv('FEISHU_APP_ID_DATA_PLATFORM', '')
FEISHU_APP_SECRET_DATA_PLATFORM = os.getenv('FEISHU_APP_SECRET_DATA_PLATFORM', '')
...
def _build_feishu_credentials():
    ...
    pairs = [
        ...
        (FEISHU_APP_ID_IAM, FEISHU_APP_SECRET_IAM),
        (FEISHU_APP_ID_DATA_PLATFORM, FEISHU_APP_SECRET_DATA_PLATFORM),
...
FEISHU_WORKSTATION_APP_IDS = {
    ...
    'iam': FEISHU_APP_ID_IAM or FEISHU_APP_ID,
    'data-platform': FEISHU_APP_ID_DATA_PLATFORM or FEISHU_APP_ID,
}
