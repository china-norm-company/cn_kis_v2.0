...
const WORKSTATIONS = [
  ...
  { key: 'control-plane', name: '天工·统管台', path: '/control-plane', color: 'bg-slate-50 text-slate-600 border-slate-200', logo: '工' },
  { key: 'digital-workforce', name: '中书·智能台', path: '/digital-workforce', color: 'bg-purple-50 text-purple-600 border-purple-200', logo: '书' },
  { key: 'data-platform', name: '洞明·数据台', path: '/data-platform', color: 'bg-cyan-50 text-cyan-700 border-cyan-300', logo: '洞' },
]
  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm text-slate-400 mt-1">系统共 {WORKSTATIONS.length} 个业务与平台工作台</p>
      </div>
