...
import { useUpdateBudget } from "../model/useBudgets";
import { Plus, Trash2 } from "lucide-react";
import type { ProjectBudget, ExpenseType } from "@/entities/finance/domain";
...
export function EditBudgetDialog({ open, onOpenChange, budget, onSuccess }: EditBudgetDialogProps) {
  ...
  const form = useForm<UpdateBudgetFormValues>({
    ...
    defaultValues: {
      ...
      sales_manager: budget.sales_manager,
      ...
      project_start_date: budget.project_start_date,
      project_end_date: budget.project_end_date,
      sample_count: budget.sample_count,
      business_sector: budget.business_sector,
    },
  });
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>编辑项目预算</DialogTitle>
          <DialogDescription>修改项目预算信息</DialogDescription>
        </DialogHeader>
