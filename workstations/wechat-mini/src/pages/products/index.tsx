...
export default function ProductsPage() {
  ...
  const handleQuickReceipt = (id: number) => {
    Taro.navigateTo({ url: `/pages/sample-confirm/index?dispensing_ids=${id}` })
  }

  const handleQuickReturn = (id: number) => {
    Taro.navigateTo({ url: `/pages/sample-return/index?dispensing_ids=${id}` })
  }

  const handleBatchReceiptProject = () => {
    if (receiptIds.length === 0) return
    Taro.navigateTo({
      url: `/pages/sample-confirm/index?dispensing_ids=${receiptIds.join(',')}&project_no=${selectedProjectNo || ''}`,
    })
  }
  ...
  const handleBatchReturnProject = () => {
    ...
    Taro.navigateTo({
      url: `/pages/sample-return/index?dispensing_ids=${returnIds.join(',')}&project_no=${selectedProjectNo || ''}`,
    })
  }
              ...
              <MiniCard key={item.dispensing_id}>
                <View className='products-item'>
                  <View
                    ...
                    onClick={() => Taro.navigateTo({ url: `/pages/products/detail?id=${item.dispensing_id}` })}
                  >
                    ...
                    <View className='products-item__footer'>
                      <View className='products-item__actions'>
                        ...
                        <Text
                          ...
                          onClick={(e) => {
                            e.stopPropagation()
                            Taro.navigateTo({ url: `/pages/products/detail?id=${item.dispensing_id}` })
                          }}
                        >
                          详情
                        </Text>
