...
export const plans = [
  {
    id: 1, plan_no: 'RP-2026-001', title: '保湿功效评价招募',
    protocol_id: 1, target_count: 40, registered_count: 35, screened_count: 28,
    enrolled_count: 22, completion_rate: 0.55, status: 'active',
    start_date: '2026-01-15', end_date: '2026-06-30', description: '40名受试者保湿功效评价',
    create_time: '2026-01-10T10:00:00', update_time: '2026-02-18T10:00:00',
  },
  {
    id: 2, plan_no: 'RP-2026-002', title: '抗衰老功效评价招募',
    protocol_id: 2, target_count: 30, registered_count: 18, screened_count: 12,
    enrolled_count: 8, completion_rate: 0.267, status: 'active',
    start_date: '2026-02-01', end_date: '2026-08-31', description: '30名受试者抗衰老功效评价',
    create_time: '2026-01-25T10:00:00', update_time: '2026-02-18T10:00:00',
  },
  {
    id: 3, plan_no: 'RP-2026-003', title: '美白功效评价招募',
    protocol_id: 3, target_count: 25, registered_count: 10, screened_count: 5,
    enrolled_count: 3, completion_rate: 0.12, status: 'draft',
    start_date: '2026-03-01', end_date: '2026-09-30', description: '25名受试者美白功效评价',
    create_time: '2026-02-10T10:00:00', update_time: '2026-02-18T10:00:00',
  },
]
