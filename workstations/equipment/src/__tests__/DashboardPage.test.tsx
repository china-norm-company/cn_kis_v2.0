...
vi.mock('@cn-kis/api-client', () => ({
  equipmentApi: {
    ...
    getCalibrationPlan: vi.fn().mockResolvedValue({ data: {} }),
    getMaintenanceStats: vi.fn().mockResolvedValue({ data: {} }),
    listMaintenance: vi.fn().mockResolvedValue({ data: {} }),
  },
...
describe('DashboardPage', () => {
  ...
  it('renders page title', async () => {
    ...
    await waitFor(() => { expect(screen.getByText('设备管理概览')).toBeInTheDocument() })
  })
})
